...
* [translate_appendix_conversations.py](../../scripts/translate_appendix_conversations.py) - Resumably translates every non-English manually clear L3–L5 conversation with local Gemma 4 26B under a strict full-fidelity prompt, using a locked JSONL cache with append-new and rewrite-changed semantics.
