...
The source of truth is [audit_long_conversations_gemma.py](../../scripts/audit_long_conversations_gemma.py). If prose documentation and executable code diverge, record the discrepancy in [log.md](/log.md) and treat the run-specific script as authoritative for reproducing that run.
